...
namespace VyazmaTech.Prachka.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20240825214802_add_reports_index")]
    partial class add_reports_index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VyazmaTech.Prachka.Domain.Core.Orders.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Price", "VyazmaTech.Prachka.Domain.Core.Orders.Order.Price#Price", b1 =>
                        {
                            b1.IsRequired();
